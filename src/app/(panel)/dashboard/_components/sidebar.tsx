    ...
    return(
        <div className="flex min-h-screen w-full">
            ...
            >
                ...
                <div className="mb-6 mt-4 items-center">
                    <Image
                        src={LogoImg}
                ...
                >
                    {!isCollapsed ? <ChevronLeft className="2-12 h-12" /> : <ChevronRight className="2-12 h-12" />}
            ...
            <div className={clsx("flex flex1 flex-col transition-all duration-300", {
                ...
                <header className="md:hidden flex items-center justify-between border-b px-2 
                    ...
                    <Sheet>
                        ...
                        <SheetContent side="left" className="sm:max-w-xs text-black">
                            <SheetTitle className="text-center text-2xl pt-4">OdontoPro</SheetTitle>
